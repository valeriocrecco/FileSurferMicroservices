...
import protos.upload_pb2 as upload__pb2
...
class UploadStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.doUpload = channel.unary_unary(
                '/uploadcsv.Upload/doUpload',
...
def add_UploadServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'doUpload': grpc.unary_unary_rpc_method_handler(
                    servicer.doUpload,
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'uploadcsv.Upload', rpc_method_handlers)
...
class Upload(object):
    ...
    def doUpload(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/uploadcsv.Upload/doUpload',
            upload__pb2.UploadRequest.SerializeToString,
            upload__pb2.UploadReply.FromString,
